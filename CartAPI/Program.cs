...
using CartAPI.ProgramExtensions;
...
builder.Services.AddHttpClient("Product", u => u.BaseAddress = new Uri(builder.Configuration.GetSection("ServicesUrls:ProductUrl").Value!));
